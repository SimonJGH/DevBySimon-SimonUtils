...
public class ListViewAdapter extends SwipeMenuAdapter<ListViewAdapter.DefaultViewHolder> {
    ...
    public View onCreateContentView(ViewGroup parent, int viewType) {
        return LayoutInflater.from(parent.getContext()).inflate(R.layout.listview_item, parent, false);
    }
