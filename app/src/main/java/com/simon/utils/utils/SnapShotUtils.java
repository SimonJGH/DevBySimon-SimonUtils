...
import static com.simon.utils.utils.ScreenUtils.getScreenHeight;
import static com.simon.utils.utils.ScreenUtils.getScreenWidth;

/**
 * 截图工具类
 * Created by Simon on 2017/10/2.
 * 使用说明：需要配合ScreenUtils使用
 */
...
public class SnapShotUtils {
     ...
     * @return
     */
    public static Bitmap shotWithStatusBar(Activity activity) {
     ...
     * @return
     */
    public static Bitmap shotWithoutStatusBar(Activity activity) {
        View view = activity.getWindow().getDecorView();
        view.setDrawingCacheEnabled(true);
        view.buildDrawingCache();
        Bitmap bmp = view.getDrawingCache();
